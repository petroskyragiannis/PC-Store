...
public class AddressActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (client.getAddress() == null) address = new Address();
            ...
            edtStreet.setText(client.getAddress().getStreet());
            edtStreetNumber.setText(client.getAddress().getNumber());
            edtTown.setText(client.getAddress().getTown());
            edtZipCode.setText(client.getAddress().getZipCode());
        }
        ...
        edtZipCode.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (zipcode != null)
                    if (zipcode.length() == 5) address.setZipCode(zipcode);
                    else showStatus("Wrong zip code format.");
            }
        });
